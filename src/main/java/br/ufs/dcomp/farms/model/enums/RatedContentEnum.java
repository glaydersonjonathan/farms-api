...
public enum RatedContentEnum {
	...
	TITLE("0", "Title"),
	TITLE_ABSTRACT("1", "Title + Abstract"),
	TITLE_ABSTRACT_INTRODUCTION("2", "Title + Abstract + Introduction"),
	TITLE_ABSTRACT_INTRODUCTION_CONCLUSION("3", "Title + Abstract + Introduction + Conclusion"),
	FULL_TEXT("4", "Full Text");
