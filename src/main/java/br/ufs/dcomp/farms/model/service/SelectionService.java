...
public class SelectionService {
    ...
    public SelectionStepCreatedDto getConfiguration(String dsKey) {
        ...
        SelectionStepCreatedDto selectionStepCreatedDto = new SelectionStepCreatedDto(selectionStep);
    ...
    public List<RatedContentCreatedDto> getAllRated() {
        List<RatedContentCreatedDto> ratedContentCreated = new ArrayList<>();
    ...
    public List<ReviewCreateDto> getReviews(String dsKey, String dsSSO) {
        List<ReviewCreateDto> reviewCreatedDto = new ArrayList<>();
        ...
        if (reviews != null) {
            reviews.forEach((review) -> {
                ...
                List<SelectionCriteriaCreatedDto> ids = new ArrayList<>();
    ...
    public Boolean realizeReview(ReviewCreateDto reviewCreateDto) {
        ...
        reviewCreateDto.getCriterias().forEach((sc) -> {
    ...
    public List<StudyCreatedDto> getStudiesInConflict(String dsKey) {
        List<StudyCreatedDto> result = new ArrayList<>();
