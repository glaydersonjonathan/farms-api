...
public class Bibtex_Extraction_Control {
	...
	public static String Bibtex_HOWPUBLISHED_extractor(Collection<org.jbibtex.BibTeXEntry> entries)
			throws ParseException {

		return extractBibtex(entries, org.jbibtex.BibTeXEntry.KEY_HOWPUBLISHED);
	}

	public static String Bibtex_INSTITUTION_extractor(Collection<org.jbibtex.BibTeXEntry> entries)
			throws ParseException {
	...
	public static String Bibtex_ORGANIZATION_extractor(Collection<org.jbibtex.BibTeXEntry> entries)
			throws ParseException {
	...
	public static Bibtex_String bibtex_Extraction(File file)
			throws TokenMgrException, ParseException, FileNotFoundException {
